...
class LRSCW_NFDCN(nn.Module):
    def __init__(self, args):
        super(LRSCW_NFDCN, self).__init__()
        # print('-----')
        nf = args.n_feats
        ...
        if self.channel_att == True:
            ...
            ResidualBlock_noBN_SE = functools.partial(arch_util.LRSCWideActResGroup, n_resblocks=n_resblocks, nf=nf)
        else:
            ResidualBlock_noBN_f = functools.partial(arch_util.WideActResBlock, nf=nf)
        ...
        # out_feats = nf * args.scale[0] * args.scale[0]
